                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="dropdown me-4">
                            <a class="btn  dropdown-toggle rounded text-white" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <i class="fa-solid fa-user-large mx-2"></i>{{ Auth::user()->name }}
                            </a>
                            <ul class="dropdown-menu">
                                <li class="my-3"><a class="dropdown-item"
                                        href="{{ route('user#accountChangePage') }}"><i
                                            class="fa-solid fa-user me-3"></i>Account</a></li>
                                <li class="my-3"><a class="dropdown-item"
                                        href="{{ route('user#passwordChangePage') }}"> <i
                                            class="fa-solid fa-key me-2"></i> Change Password</a></li>
                                <li class="my-3">
                                    <form action="{{ route('logout') }}" class=" ml-3 d-inline" method="post">
                                        @csrf
