                              ...
                              <form action="{{ route('admin#change', $account->id) }}" method="post"
                                  ...
                                  <div class="row">
                                      <div class="col-3 offset-1">
                                          ...
                                          @else
                                              <img src="{{ asset('storage/' . $account->image) }}" class=""
                                                  alt="">
                                          @endif
                                      ...
                                      <div class="col-6 offset-1 bg-success-subtle rounded p-2 ps-4">
                                          ...
                                          <h4 class="my-3 d-flex align-items-center"><i
                                                  class="fa-solid fa-person-circle-minus me-4  p-2"></i>
                                              <span>
                                                  <label for="pp" class="ms-2">Role</label><br>
                                          ...
                                          <h4 class="my-3 d-flex align-items-center"><i
                                              ...
                                              <span><label for="pp" class="ms-2">Email</label><br><input
                                                      ...
                                                      class="rounded p-2 my-1 form-control @error('email')
                                                          is-invalid
                                                      @enderror"
                                                      value="{{ old('email', $account->email) }}" name="email"
                                              ...
                                              <span>
                                                  ...
                                                  <input type="number"
                                                      class="rounded p-2 my-1 form-control @error('phone')
                                                          is-invalid
                                                      @enderror "
                                                      value="{{ old('phone', $account->phone) }}" name="phone"
                                          ...
                                          <h4 class="my-3  d-flex align-items-center"><i
                                                  ...
                                                  <textarea name="address"
                                                      class="rounded p-2 my-1 form-control @error('address')
                                                          is-invalid
                                                      @enderror"
                                                      placeholder="Enter your address" id="" cols="30" rows="10" disabled>{{ old('address', $account->address) }}</textarea>
                                                  @error('address')
                                                      <span class="invalid-feedback">{{ $message }}</span>
                                                  @enderror
                                              </span>
                                          ...
                                          <h4 class="mb-3 d-flex"><i class="fa-solid fa-calendar me-4 p-2"></i>
                                              <span class=""><label for="p" class="">Created
                                                      ...
                                                      value="{{ $account->created_at->format('d-F-Y') }}" disabled>
                                              </span>
                                          </h4>
