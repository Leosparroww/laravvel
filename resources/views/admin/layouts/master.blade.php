...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{ asset('admin/images/icon/logo.png') }}" alt="Cool " />
                </a>
            </div>
                    ...
                    <ul class="list-unstyled navbar__list ">
                        ...
                        <li>
                            <a href="{{ url('category/list') }} " class="text-decoration-none">
                                <i class="fas fa-chart-bar " style="color: #1a9db7;"></i>Category</a>
                        </li>
                        <li>
                            <a href="{{ route('product#list') }}" class="text-decoration-none">
                                <i class="fa-solid fa-list" style="color: #1a9db7;"></i></i>Product list</a>
                        </li>
                        <li>
                            <a href="{{ route('order#list') }}" class="text-decoration-none">
                                <i class="fa-solid fa-table-list" style="color: #ff3300;"></i>Order list</a>
                        </li>
                        <li>
                            <a href="{{ route('user#list') }}" class="text-decoration-none">
                                <i class="fa-solid fa-users-line" style="color: #005cfa;"></i></i>User list</a>
                        </li>
                        <li>
                            <a href="{{ route('user#messageList') }}" class="text-decoration-none">
                                <i class="fa-solid fa-comment-sms" style="color: #0501f4;"></i></i>User Messages</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('admin#details') }}"
                                                        ...
                                                        <i class="fa-solid fa-user-large"></i>Account</a>
                                                </div>
                                                <div class="account-dropdown__item">
                                            ...
                                            <div class="account-dropdown__footer">
                                                ...
                                                <form action="{{ route('logout') }}" method="post"
                                                    ...
                                                    @csrf
                                                    <button type="submit" class="account-dropdown__item"><i
                                                            class="zmdi zmdi-power"></i>Logout</a></button>
                                                </form>
